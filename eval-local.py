...
for episode in tqdm(range(10), desc="Evaluating"):
    ...
    t = 0
    # print(f'##\n\n\n\n\nenv.spec.timestep_limit: {env.spec.timestep_limit}')
    # exit()
    while True:
        ...
        # print(f'[{t}] episode_reward: {episode_reward}')
    ...
    print(f'eps-{episode} reward: {episode_reward}')
